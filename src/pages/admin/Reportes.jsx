      ...
      <main style={styles.main}>
        ...
        {!generado && !loading && (
          <div style={styles.initialStateCard}>
            ...
            <p style={styles.initialStateText}>
              Selecciona los filtros requeridos y haz clic en <strong>Generar Reporte</strong> para visualizar las materias
            </p>
          </div>
        )}
        ...
        {generado && materias.length === 0 && (
          <div style={styles.emptyStateCard}>
            ...
            <p style={styles.emptyStateDesc}>No hay materias registradas para los filtros seleccionados.</p>
          </div>
        )}
      </main>
